...
public class C05_SoftAssert {
    ...
    public void amazonTest(){
        ...
        String actualUrunIsim=amazonPage.aramaSonucElementi.getText();

        softAssert.assertTrue(actualUrunIsim.contains(expectedIcerik),"arama sonucu nutella içermiyor");
