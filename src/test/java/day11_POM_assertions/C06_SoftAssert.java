...
public class C06_SoftAssert {
    ...
    public void webappTest(){
        ...
        softAssert.assertEquals(actualSecim,expectedSecim,"dropdownda eurozone secili değil ");
        ...
        List<String> actaulOptionsStringList= ReusableMethods.stringListeCevir(optionsElementListesi);
        ...
        softAssert.assertEquals(actaulOptionsStringList,expectedOptionListesi);
